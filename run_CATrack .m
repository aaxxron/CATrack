...
function results = run_CATrack(seq)  

%  Initialize path
addpath(genpath('.\tracker_v1.0\feature'));
addpath(genpath('.\tracker_v1.0\implementation'));
addpath(genpath('.\tracker_v1.0\utils'));
...
%  Scale parameters
params.scale_sigma_factor=0.5; %0.5 
